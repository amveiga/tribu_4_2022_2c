    ...
    <div className="body">
        ...
        <div id="main">
            ...
            <div className="div-container">
                ...
                <div className="div-section">
                    <label for="project-select-task">Buscar tipo de tarea para cargar horas:</label>
                    <select name="project-task" id="project-task">
                        ...
                        <option value="tarea1">Proyecto</option>
                        <option value="tarea2">Incidencia</option>
                        <option value="tarea2">Administrativa</option>
                        <option value="tarea2">Guardia</option>
                        <option value="tarea2">Licencia</option>
                    </select>
                </div>
                ...
                <div className="div-loader hidden">
                    <div className="div-section">
                        <label for="project-select-task">Buscar incidencia para cargar horas:</label>
                        <select name="project-task" id="project-task">

    ...
    <div className="body">
        ...
        <div id="main">
            <div className="task-buttons">
                ...
                <input className="task-button incidence-button" type="button" value="Cargar horas de trabajo en incidencias" onClick={verTareas}/>
...
export default CargarIncidencias;
